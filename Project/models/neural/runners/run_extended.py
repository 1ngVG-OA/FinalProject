"""Run Step 5 neural extended experiment with a wider MLP/LSTM search space."""
...
def run_extended() -> None:
    ...
    neural_cfg = build_extended_neural_config()
    ...
    out_paths = {
        "preproc_candidates": preproc_metrics_dir / "candidate_tests_neural_extended.csv",
        "preproc_selected_config": preproc_artifacts_dir / "selected_config_neural_extended.json",
        "grid": neural_metrics_dir / "grid_extended.csv",
        "summary": neural_metrics_dir / "summary_extended.csv",
        "forecasts": neural_metrics_dir / "forecasts_extended.csv",
        "winner": neural_artifacts_dir / "winner_params_extended.json",
        "config": neural_artifacts_dir / "config_extended.json",
    }
    ...
    plot_paths = save_neural_plots(output, plots_dir, suffix="extended")

    print(f"Step 5 neural extended completed. Winner: {output['winner']}")
    print("Saved outputs:")
