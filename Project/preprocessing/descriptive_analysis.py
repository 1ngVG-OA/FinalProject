...
from config import DEFAULT_SERIES_KEY, get_series_config
...
def load_target_series(dataset_path: Path, target: str = DEFAULT_SERIES_KEY) -> pd.Series:

    # Validazione dell'input target e risoluzione della relativa configurazione.
    series_cfg = get_series_config(target)
    ...
    target_col = series_cfg.target_column_index
    ...
    series_name = series_cfg.target_series_name
